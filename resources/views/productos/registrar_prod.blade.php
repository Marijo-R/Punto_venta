                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-content">
                            <form class="col s12" novalidate method="POST" action="{{ route('storeProd') }}">
                                @csrf
                                <div class="row">
                                    <div class="col s12 m2 ">
                                        <label for="codigo" class="form-label">Código</label>
                                        <input type="varchar" class="form-control" name="codigo" id="codigo"
                                            class="validate" placeholder="Código">
                                    </div>
                                    <div class="col s12 m3 ">
                                        ...
                                        <input type="varchar" class="form-control" name="codigo_alterno" id="codigo_alterno"
                                            class="validate" placeholder="Código alterno">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col s12 m7">
                                        ...
                                        <input type="varchar" name="descripcion" id="descripcion"
                                            class="form-control validate" placeholder="Descripción..." data-length="255" />
                                    </div>
                                    <div class="col s12 m3">
                                ...
                                <div class="row">
                                    <div class="col s12 m4">
                                        ...
                                        <input id="utilidad_porcentaje" name="utilidad_porcentaje" class="form-control"
                                            type="varchar" class="validate" placeholder="%">
                                    </div>
                                    <div class="col s12 m4">
