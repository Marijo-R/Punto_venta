                                ...
                                <div class=" col-md-12">
                                    <div class="row">
                                        <div class="btn-group col-md-2 right">
                                            <a href="{{ route('recycleProvFis') }}" class="btn btn-warning">
                                                <i class="material-icons left">delete_sweep</i>PAPELERA
                                            </a>
                                        </div>
                                        <div class="btn-group col-md-2 right">
                                            <a href="{{ route('createProvFis') }}" class="btn btn-success">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 right">
                                            <form action="{{ route('indexProvFis') }}" method="GET">
                                                <div class="dataTables_length" id="dataTables-example_length">
                                                    <label>
                                                        Buscar
                                        ...
                                        @else
                                            @foreach ($proveedores as $proveedor)
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">{{ $proveedor->curp }}</td>
                                                    <td class="center">{{ $proveedor->telefono }}</td>
                                                    <td class="center">{{ $proveedor->email }}</td>
                                                    <td class="center" WIDTH="70">
                                                        <a href="{{ route('editProvFis', $proveedor->id_proveedor) }}"
                                                    ...
                                                    <td class="center" WIDTH="70">
                                                        <form
                                                            action="{{ route('destroyProvFis', $proveedor->id_proveedor) }}"
                                                            method="POST">
                                                            {{ method_field('DELETE') }}
                                                            {{ @csrf_field() }}
                                                            <button type="submit"
