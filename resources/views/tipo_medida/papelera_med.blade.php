                                ...
                                <div class=" col-md-12">
                                    <div class="row">
                                        <div class="btn-group col-md-2 right">
                                            <a href="{{ route('indexMed') }}" class="btn btn-warning">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 right">
                                            <form action="{{ route('recycleMed') }}" method="GET">
                                                <div class="dataTables_length" id="dataTables-example_length">
                                                    <label>
                                            ...
                                            @foreach ($medidas as $medida)
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <a onclick="Alertabtn()">
                                                            <button
                                                                onclick="location.href='{{ route('recoverMed', $medida->id_medida) }}'"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="dataTables_info" id="dataTables-example_info" role="alert"
                                            ...
                                            Mostrando {{ $medidas->count() }} de {{ $medidas->total() }} entradas
                                        </div>
                                    </div>

                                    <div class="col-sm-4 right">
                                        <div>
                                            {{ $medidas->links('vendor.pagination.default') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
