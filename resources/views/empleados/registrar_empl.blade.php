            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-content">
                        <form class="col s12" novalidate method="POST" action="{{ route('storeEmpl') }}">
                        @csrf
                        <div><label><strong>DATOS PERSONALES</strong></label></div>
                            <div class="row">
                                <div class="col s12 m2">
                                    <label for="marca">{{ __('Puesto') }}</label>
                                    <select id="id_puesto" name="id_puesto" type="varchar" class="form-control">
                                ...
                                <div class="col s12 m2 ">
                                    ...
                                    <input type="varchar" class="form-control" id="alias" 
                                          name="alias" placeholder="Eve" value="{{ old('alias') }}">
                                    @if($errors->has('alias'))
                                        <span class="error text-danger">
                                            {{$errors->first('alias')}}
                                        </span>
                                ...
                                <div class="col s12 m3 ">
                                    ...
                                    <input type="varchar" class="form-control validate" id="nombre" 
                                            name="nombre" placeholder="Evelyn" value="{{ old('nombre') }}">
                                ...
                                <div class="col s12 m3 ">
                                    ...
                                    <input type="varchar" class="form-control validate" id="primer_apellido"  
                                         name="primer_apellido" placeholder="Baz" value="{{ old('primer_apellido') }}">
                                ...
                                <div class="col s12 m2">
                                    ...
                                    <input type="varchar" class="form-control validate" id="segundo_apellido" 
                                          name="segundo_apellido" placeholder="Pérez" value="{{ old('segundo_apellido') }}">
                            ...
                            <div class="row">
                                <div class="col s12 m4">
                                    ...
                                    <input type="char" id="nss" class="form-control validate" 
                                           name="nss" placeholder="72795608040" value="{{ old('nss') }}">
                                    @if($errors->has('nss'))
                                        <span class="error text-danger">
                                            {{$errors->first('nss')}}
                                        </span>
                                ...
                                <div class="col s12 m5">
                                    ...
                                    <input type="char" id="curp" name="curp" class="form-control validate" 
                                           placeholder="BAPE001011MVZNRVA6" value="{{ old('curp') }}">
                                    @if($errors->has('curp'))
                                        <span class="error text-danger">
                                            {{$errors->first('curp')}}
                                        </span>
                                ...
                                <div class="col s12 m3">
                                    ...
                                    <input type="varchar" id="fecha_nac" name="fecha_nac" class="form-control validate" 
                                           placeholder="2000-10-11 --> año-mes-día" value="{{ old('fecha_nac') }}">
                            ...
                            <div class="row">
                                <div class="col s12 m4">
                                    ...
                                    <input type="varchar" class="form-control validate" id="email" 
                                          name="email"  placeholder="evemi1110@gmail.com" value="{{ old('email') }}">
                                    @if($errors->has('email'))
                                        <span class="error text-danger">
                                            {{$errors->first('email')}}
                                        </span>
                                ...
                                <div class="col s12 m4">
                                    ...
                                    <input type="varchar" id="telefono" name="telefono" class="form-control validate" 
                                           placeholder="2721478987" value="{{ old('telefono') }}">
                            ...
                            <div class="row">
                                <div class="col s12 m3">
                                    ...
                                    <input type="varchar" class="form-control validate" id="calle" 
                                           name="calle" placeholder="Avenida San Juan" value="{{ old('calle') }}">
                                    @if($errors->has('calle'))
                                        <span class="error text-danger">
                                            {{$errors->first('calle')}}
                                        </span>
                                ...
                                <div class="col s12 m3">
                                    ...
                                    <input type="varchar" id="entre_calles" name="entre_calles" class="form-control validate" 
                                           placeholder="Mezón y Guadalupe" value="{{ old('entre_calles') }}">
                                ...
                                <div class="col s12 m3">
                                    ...
                                    <input type="varchar" id="no_interior" name="no_interior" class="form-control validate" 
                                          placeholder="18" value="{{ old('no_interior') }}">
                            ...
                            <div class="row">
                                <div class="col s12 m4">
                                    ...
                                    <input type="varchar" class="form-control validate" id="cod_postal"  
                                          name="cod_postal" placeholder="94760" value="{{ old('cod_postal') }}">
                                ...
                                <div class="col s12 m4">
                                    ...
                                    <input type="varchar" id="localidad"  class="form-control validate" 
                                          name="localidad" placeholder="Acultzingo" value="{{ old('localidad') }}">
