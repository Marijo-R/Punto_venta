                            ...
                            <div class=" col s12">
                                <div class="row">
                                    <div class="btn-group  col s12 m2 right">
                                        <span tooltip="Clic para recuperar registros eliminados" flow="left">
                                            <a href="{{ route('recycleCliMor') }}" class="btn btn-warning">
                                    ...
                                    <div class="btn-group col s12 m2 right">
                                        <span tooltip="Clic para registrar nuevo empleado" flow="left">
                                            <a href="{{ route('createCliMor') }}" class="btn btn-success">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 right">
                                        <form action="{{ route('indexCliMor') }}" method="GET">
                                            <div class="dataTables_length" id="dataTables-example_length">
                                                <label>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center" WIDTH="70">
                                                <span tooltip="Clic para editar cliente" flow="left">
                                                    <a href="{{ url('editCliMor', $cliente->id_cliente) }}"
                                            ...
                                            <td class="center" WIDTH="70">
                                                <span tooltip="Clic para eliminar cliente" flow="left">
                                                    <form action="{{ url('destroyCliMor', $cliente->id_cliente) }}"
                                                            method="POST">
                                                        {{ method_field('DELETE') }}
                                                        {{ @csrf_field() }} 
