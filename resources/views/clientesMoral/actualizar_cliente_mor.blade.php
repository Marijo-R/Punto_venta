                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-content">
                                <form class="col s12" novalidate method="POST" action="{{ route('updateCliMor', $cliente->id_cliente') }}">
                                @csrf
                                    <div class="row">
                                        <div class="col s12 m2 ">
                                            <label for="numcli" class="form-label">{{ __('No. cliente') }}</label>
                                            <input type="varchar" class="form-control validate" value="{{ old('no_cliente',$cliente->no_cliente)"
                                    ...
                                    <div class="row">
                                        <div class="col s12 m6 " >
                                            ...
                                            <input type="varchar" class="form-control validate" id="razon_social" 
                                                    name="razon_social" placeholder="S.A DE C.V" value="{{ old('razon_social',$cliente->razon_social) }}">
                                        ...
                                        <div class="col s12 m6">
                                            ...
                                            <input type="varchar" id="rfc" name="rfc" class="form-control validate" 
                                                    placeholder="PAQUIN9510D2" value="{{ old('rfc',$cliente->rfc) }}">
                                            @if($errors->has('rfc'))
                                                <span class="error text-danger">
                                                    {{$errors->first('rfc')}}
                                                </span>
