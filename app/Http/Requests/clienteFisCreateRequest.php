...
class clienteFisCreateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'comentarios' => ['required', 'regex:/^([0-9a-zA-ZñÑáéíóúÁÉÍÓÚ_-])+((\s*)+([0-9a-zA-ZñÑáéíóúÁÉÍÓÚ_-]*)*)+$/', 'alpha_num', 'min:4','max:255'],
